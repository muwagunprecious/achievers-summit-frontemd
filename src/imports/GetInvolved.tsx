    ...
    <div className="absolute h-[1347.21px] left-[-143.12px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[143.117px_-2566.39px] mask-size-[1440px_5338.391px] top-[2566.39px] w-[2152.71px]" data-name="Group" style={{ maskImage: `url('${imgGroup}')` }}>
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2152.71 1347.21">
        <g id="Group" opacity="0.07">
          ...
          <path d={svgPaths.p18992440} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_20" />
          ...
          <path d={svgPaths.p247a00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_23" />
          <path d={svgPaths.p24052300} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_24" />
          <path d={svgPaths.p28045e80} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_25" />
          <path d={svgPaths.p3017bf00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_26" />
          <path d={svgPaths.p1e6afd00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_27" />
          <path d={svgPaths.p7568e00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_28" />
          <path d={svgPaths.p4bdaf00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_29" />
          <path d={svgPaths.p7322080} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_30" />
          <path d={svgPaths.p8dcce00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_31" />
          <path d={svgPaths.p2fd86a00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_32" />
          <path d={svgPaths.p1edbac00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_33" />
          <path d={svgPaths.p2d134500} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_34" />
          <path d={svgPaths.p392bc000} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_35" />
          <path d={svgPaths.p3f931880} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_36" />
          <path d={svgPaths.p2a321d00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_37" />
          <path d={svgPaths.p7c2be00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_38" />
          <path d={svgPaths.p11410b00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_39" />
          <path d={svgPaths.p266a8660} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_40" />
          <path d={svgPaths.p758af00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_41" />
          <path d={svgPaths.p18e3bb00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_42" />
          <path d={svgPaths.p3a8df7e0} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_43" />
          <path d={svgPaths.p2ab20100} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_44" />
          <path d={svgPaths.p22cbc000} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_45" />
          <path d={svgPaths.p35c0b780} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_46" />
          <path d={svgPaths.p1702d03a} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_47" />
          <path d={svgPaths.pe9a2300} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_48" />
          <path d={svgPaths.pc672d72} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_49" />
          <path d={svgPaths.p26e89c00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_50" />
          <path d={svgPaths.p919d900} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_51" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="h-[16px] relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[13px] items-center py-[60px] relative size-full">
          <div className="bg-[#f0f1f4] h-[2.5px] shrink-0 w-[35px]" />
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[16px] text-center tracking-[1.6px] w-[133px]">
            <p className="leading-[1.02]">GET INVOLVED</p>
          </div>
        </div>
      </div>
...
function Frame26() {
  return (
    <div className="content-stretch flex flex-col gap-[45px] items-start relative self-stretch shrink-0 w-[634px]">
      <div className="flex flex-col font-['Oswald:Bold',sans-serif] font-bold justify-center relative shrink-0 text-[#f0f1f4] text-[72px] w-[396.672px]">
        <p className="leading-[1.05]">JOIN AS A BUILDER</p>
      </div>
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center min-w-full not-italic relative shrink-0 text-[#a4c6e6] text-[24px] text-justify tracking-[-1.44px] w-[min-content]">
        <p className="leading-[1.4]">The Achievers Summit is built on partnership. Whether you have knowledge to share, a brand to activate, or solutions to showcase — there is a role for you at the table.</p>
      </div>
    </div>
  );
}
...
function Frame55() {
  return <div className="bg-[#a4c6e6] col-1 h-[315.505px] ml-[27.77px] mt-0 row-1 w-[429.987px]" />;
}

function Frame56() {
  return <div className="bg-[#f0f1f4] col-1 h-[315.505px] ml-0 mt-[24.5px] row-1 w-[429.987px]" />;
}
...
function Frame57() {
  return <div className="bg-[#a4c6e6] h-[315.505px] w-[429.987px]" />;
}

function Frame58() {
  return <div className="bg-[#f0f1f4] h-[315.505px] w-[429.987px]" />;
}

function Group9() {
  return (
    <div className="absolute contents left-0 top-0">
      <div className="absolute flex h-[315.505px] items-center justify-center left-0 top-0 w-[429.987px]">
        <div className="-scale-y-100 flex-none rotate-180">
          <Frame57 />
        </div>
      </div>
      <div className="absolute flex h-[315.505px] items-center justify-center left-[27.77px] top-[24.5px] w-[429.987px]">
        <div className="-scale-y-100 flex-none rotate-180">
          <Frame58 />
        </div>
      </div>
  ...
  return (
    <div className="h-[16px] relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[13px] items-center py-[60px] relative size-full">
          <div className="bg-[#f0f1f4] h-[2.5px] shrink-0 w-[35px]" />
          <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#f0f1f4] text-[16px] tracking-[1.6px]">
            <p className="leading-[1.02]">BECOME A SPEAKER</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame28() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <div className="flex flex-col font-['Oswald:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#f0f1f4] text-[48px] w-[396.672px]">
        <p className="leading-[1.05]">APPLY TO SPEAK</p>
      </div>
    </div>
  );
}
...
function Frame29() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[0px] text-justify tracking-[0.36px] w-full whitespace-pre-wrap">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.4] mb-0 text-[#a4c6e6] text-[24px] tracking-[-1.44px]">{`Bring Your Voice to Africa's Biggest Stage`}</p>
        <p className="leading-[1.2] mb-0 text-[18px]">&nbsp;</p>
        <p className="leading-[1.2] text-[18px]">{`We accept applications for keynote speakers, panel discussants, workshop facilitators and fireside guests across all four content tracks. If you have a perspective that challenges, inspires or reframes how Africa's future leaders think — we want to hear from you. You will be speaking to 5,000+ in-person attendees and a virtual audience of 25,000+ across Africa and the diaspora.`}</p>
      </div>
    </div>
  );
}
...
function Frame70() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[45px] items-start left-[569.76px] top-[22px] w-[678.242px]">
      <Frame27 />
      <Frame69 />
    </div>
  );
...
function Frame71() {
  return (
    <div className="h-[340px] relative shrink-0 w-[1248px]">
      <Group9 />
      <Frame70 />
    </div>
  );
...
function Frame30() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-full">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[32px] text-center w-[396.672px]">
        <p className="leading-[1.02] whitespace-pre-wrap">{`WHAT  YOU GET`}</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[18px] tracking-[0.36px] whitespace-nowrap">
        <p className="leading-[1.2]">Full speaker profile across all Summit media channels</p>
      </div>
    </div>
  );
}
...
function Frame76() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[18px] tracking-[0.36px] whitespace-nowrap">
        <p className="leading-[1.2]">Access to the Investor Roundtable and Deal Room</p>
      </div>
    </div>
  );
}
...
function Frame77() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[18px] tracking-[0.36px] whitespace-nowrap">
        <p className="leading-[1.2]">Complimentary Business Class Summit pass</p>
      </div>
    </div>
  );
}
...
function Frame80() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[18px] tracking-[0.36px] whitespace-nowrap">
        <p className="leading-[1.2]">{`Feature across The Guardian Newspaper, Arise TV & TVC News`}</p>
      </div>
    </div>
  );
}
...
function Frame81() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[18px] tracking-[0.36px] whitespace-nowrap">
        <p className="leading-[1.2]">{`Invitation to the 100 Under 40 Awards Gala & Dinner`}</p>
      </div>
    </div>
  );
}
...
function Frame73() {
  return (
    <div className="content-stretch flex flex-col h-[150px] items-center relative shrink-0 w-[1248px]">
      <Frame74 />
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="bg-[#a4c6e6] content-stretch flex gap-[10px] items-center justify-center px-[28px] py-[14px] relative shrink-0">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#050b11] text-[19px] text-center tracking-[-1.14px] whitespace-nowrap">
        <p className="leading-[1.02]">Apply to speak</p>
      </div>
      <div className="relative shrink-0 size-[24px]" data-name="Arrow_alt_lright">
        <div className="absolute bottom-[33.33%] flex items-center justify-center left-1/4 right-1/4 top-[33.33%]">
          <div className="-scale-y-100 flex-none h-[8px] rotate-180 w-[12px]">
...
function Frame65() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[60px] items-center justify-center left-[96px] pb-[120px] top-[753px] w-[1248px]">
      <Frame71 />
      <Frame72 />
    </div>
  );
    ...
    <div className="h-[16px] relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[13px] items-center py-[60px] relative size-full">
          <div className="bg-[#f0f1f4] h-[2.5px] shrink-0 w-[35px]" />
          <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#f0f1f4] text-[16px] tracking-[1.6px]">
            <p className="leading-[1.02]">EXHIBIT YOUR BRAND</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame32() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <div className="flex flex-col font-['Oswald:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#f0f1f4] text-[48px] w-[396.672px]">
        <p className="leading-[1.05]">APPLY TO EXHIBIT</p>
      </div>
    </div>
  );
}
...
function Frame33() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[0px] text-justify tracking-[0.36px] w-full whitespace-pre-wrap">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.4] mb-0 text-[#a4c6e6] text-[24px] tracking-[-1.44px]">Put Your Brand in the Room That Matters</p>
        <p className="leading-[1.2] mb-0 text-[18px]">&nbsp;</p>
        <p className="leading-[1.2] text-[18px]">The Achievers Summit Exhibition Floor is one of the most active business environments in West Africa. Over three days, your brand will be seen, tested and remembered by founders, executives, government officials and media personalities. We offer exhibition spaces for product brands, service companies, institutions, startups and social enterprises.</p>
      </div>
    </div>
  );
}
...
function Frame84() {
  return (
    <div className="content-stretch flex flex-col gap-[45px] h-[296px] items-start relative shrink-0 w-[678.242px]">
      <Frame31 />
      <Frame85 />
    </div>
  );
...
function Frame83() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[1248px]">
      <Frame84 />
      <Group11 />
    </div>
  );
...
function Frame90() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[18px] tracking-[0.36px] whitespace-nowrap">
        <p className="leading-[1.2]">Premium placement on the high-traffic Exhibition Floor</p>
      </div>
    </div>
  );
}
...
function Frame91() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[18px] tracking-[0.36px] whitespace-nowrap">
        <p className="leading-[1.2]">Access to 5,000+ curated, high-intent attendees over 3 days</p>
      </div>
    </div>
  );
}
...
function Frame92() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[18px] tracking-[0.36px] whitespace-nowrap">
        <p className="leading-[1.2]">Two complimentary Economy Class passes for your team</p>
      </div>
    </div>
  );
}
...
function Frame94() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[18px] tracking-[0.36px] whitespace-nowrap">
        <p className="leading-[1.2]">Brand activation rights — demos, sampling, experiential setups</p>
      </div>
    </div>
  );
}
...
function Frame95() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[18px] tracking-[0.36px] whitespace-nowrap">
        <p className="leading-[1.2]">Featured in the official Summit programmes</p>
      </div>
    </div>
  );
}
...
function Frame96() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[18px] tracking-[0.36px] whitespace-nowrap">
        <p className="leading-[1.2]">Post-event exhibitor spotlight across EAI media channels</p>
      </div>
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="bg-[#a4c6e6] content-stretch flex gap-[10px] items-center justify-center px-[28px] py-[14px] relative shrink-0">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#050b11] text-[19px] text-center tracking-[-1.14px] whitespace-nowrap">
        <p className="leading-[1.02]">Apply to exhibit</p>
      </div>
      <div className="relative shrink-0 size-[24px]" data-name="Arrow_alt_lright">
        <div className="absolute bottom-[33.33%] flex items-center justify-center left-1/4 right-1/4 top-[33.33%]">
          <div className="-scale-y-100 flex-none h-[8px] rotate-180 w-[12px]">
...
function Frame66() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[60px] items-center justify-center left-[96px] pb-[120px] top-[1535px] w-[1248px]">
      <Frame83 />
      <Frame86 />
    </div>
  );
    ...
    <div className="h-[16px] relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[13px] items-center py-[60px] relative size-full">
          <div className="bg-[#f0f1f4] h-[2.5px] shrink-0 w-[35px]" />
          <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#f0f1f4] text-[16px] tracking-[1.6px]">
            <p className="leading-[1.02]">SPONSORSHIP</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame36() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <div className="flex flex-col font-['Oswald:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#f0f1f4] text-[48px] w-[396.672px]">
        <p className="leading-[1.05]">BECOME A SPONSOR</p>
      </div>
    </div>
  );
}
...
function Frame37() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[0px] text-justify tracking-[0.36px] w-full whitespace-pre-wrap">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.4] mb-0 text-[#a4c6e6] text-[24px] tracking-[-1.44px]">{`Align Your Brand with Africa's Leadership Conversation`}</p>
        <p className="leading-[1.2] mb-0 text-[18px]">&nbsp;</p>
        <p className="leading-[1.2] text-[18px]">{`Sponsoring the Achievers Summit is not a logo placement — it is a strategic positioning. Your brand is associated with excellence, influence and the aspirations of Africa's most ambitious generation. Available categories: Title Partner, Ecosystem Partner, Official Drink & Snack Partner, CSR Drive Partner, and Media Partnership.`}</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full">
      ...
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#f0f1f4] text-[18px] tracking-[0.36px]">
        <p className="leading-[1.2]">Brand placement across all Summit touchpoints — physical and digital</p>
      </div>
    </div>
  );
}
...
function Frame107() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full">
      ...
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#f0f1f4] text-[18px] tracking-[0.36px]">
        <p className="leading-[1.2]">{`Named presence across The Guardian, Arise TV & TVC News coverage`}</p>
      </div>
    </div>
  );
}
...
function Frame108() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[18px] tracking-[0.36px] whitespace-nowrap">
        <p className="leading-[1.2]">Speaking slot within your category (select packages)</p>
      </div>
    </div>
  );
}
...
function Frame109() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[18px] tracking-[0.36px] whitespace-nowrap">
        <p className="leading-[1.2]">Exclusive access to Investor Roundtable (select packages)</p>
      </div>
    </div>
  );
}
...
function Frame105() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-[624px]">
      <Frame106 />
      <Frame107 />
      <Frame108 />
      <Frame109 />
...
function Frame111() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[18px] tracking-[0.36px] whitespace-nowrap">
        <p className="leading-[1.2]">{` Dedicated activation window during Summit sessions`}</p>
      </div>
    </div>
  );
}
...
function Frame112() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[18px] tracking-[0.36px] whitespace-nowrap">
        <p className="leading-[1.2]">Access to attendee engagement data and post-event analytics</p>
      </div>
    </div>
  );
}
...
function Frame113() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[18px] tracking-[0.36px] whitespace-nowrap">
        <p className="leading-[1.2]">Co-branded CSR association with the Makoko Foodbank Drive</p>
      </div>
    </div>
  );
}
...
function Frame114() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[18px] tracking-[0.36px] whitespace-nowrap">
        <p className="leading-[1.2]">VIP Gala Night table for senior brand representatives</p>
      </div>
    </div>
  );
}
...
function Frame103() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-[1248px]">
      <Frame104 />
    </div>
  );
}
...
function Frame67() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[60px] items-center justify-center left-[96px] pb-[120px] top-[2317px] w-[1248px]">
      <Frame98 />
      <Frame101 />
    </div>
  );
  ...
  return (
    <div className="content-stretch flex gap-[13px] items-center relative shrink-0">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[16px] text-center tracking-[1.6px] whitespace-nowrap">
        <p className="leading-[1.02]">THE ACHIEVERS SUMMIT 2026</p>
      </div>
    </div>
  );
}
...
export default function GetInvolved() {
  return (
    <div className="relative size-full" data-name="Get Involved">
