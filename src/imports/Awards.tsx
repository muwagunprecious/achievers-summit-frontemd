    ...
    <div className="absolute h-[1350px] left-[-144.51px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[144.508px_-1215px] mask-size-[1440px_5338.391px] top-[1215px] w-[2155.5px]" data-name="Group" style={{ maskImage: `url('${imgGroup}')` }}>
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2155.5 1350">
        <g id="Group" opacity="0.07">
          ...
          <path d={svgPaths.p1baf1180} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_21" />
          <path d={svgPaths.p13f1a760} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_22" />
          <path d={svgPaths.p11d89b0} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_23" />
          <path d={svgPaths.p3d1ec180} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_24" />
          <path d={svgPaths.p21055c00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_25" />
          <path d={svgPaths.p2c196380} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_26" />
          <path d={svgPaths.pa2e1d30} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_27" />
          <path d={svgPaths.p6c04580} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_28" />
          <path d={svgPaths.p2f325700} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_29" />
          <path d={svgPaths.p98ffa00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_30" />
          <path d={svgPaths.p2e11bff0} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_31" />
          <path d={svgPaths.p58fb900} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_32" />
          <path d={svgPaths.p7bc4880} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_33" />
          <path d={svgPaths.p18a6de40} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_34" />
          <path d={svgPaths.p1f54a100} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_35" />
          <path d={svgPaths.p113e0700} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_36" />
          <path d={svgPaths.p52e6000} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_37" />
          <path d={svgPaths.p37b72b00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_38" />
          <path d={svgPaths.pf478d80} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_39" />
          <path d={svgPaths.p30b1cd00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_40" />
          <path d={svgPaths.pc5aec00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_41" />
          <path d={svgPaths.pa49ded0} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_42" />
          <path d={svgPaths.p1a65e100} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_43" />
          <path d={svgPaths.p16b34f00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_44" />
          <path d={svgPaths.p3edf2080} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_45" />
          <path d={svgPaths.p33c27100} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_46" />
          <path d={svgPaths.p35d90980} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_47" />
          <path d={svgPaths.p37f23900} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_48" />
          <path d={svgPaths.p366da400} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_49" />
          <path d={svgPaths.p1e953c40} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_50" />
          <path d={svgPaths.p20972f80} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_51" />
          <path d={svgPaths.p3ee9b000} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_52" />
        </g>
      </svg>
    </div>
  );
...
function Group3() {
  return (
    <div className="absolute h-[1350px] left-[-144.51px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[144.508px_-2565px] mask-size-[1440px_5338.391px] top-[2565px] w-[2155.5px]" data-name="Group" style={{ maskImage: `url('${imgGroup}')` }}>
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2155.5 1350">
        <g id="Group" opacity="0.07">
          <path d={svgPaths.p2b438480} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector" />
          <path d={svgPaths.p317ae700} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_2" />
          <path d={svgPaths.p116ee600} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_3" />
          <path d={svgPaths.p292694c0} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_4" />
          <path d={svgPaths.p10ec7700} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_5" />
          ...
          <path d={svgPaths.p23e6e500} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_21" />
          <path d={svgPaths.p2c843400} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_22" />
          <path d={svgPaths.pe31cff1} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_23" />
          <path d={svgPaths.p607e4b0} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_24" />
          <path d={svgPaths.p313df740} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_25" />
          <path d={svgPaths.p3733b900} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_26" />
          <path d={svgPaths.p40b3b00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_27" />
          <path d={svgPaths.p10d05c00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_28" />
          <path d={svgPaths.p3a335980} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_29" />
          <path d={svgPaths.p2149800} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_30" />
          <path d={svgPaths.p1f44300} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_31" />
          <path d={svgPaths.p2b234e80} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_32" />
          <path d={svgPaths.p3984ebc0} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_33" />
          <path d={svgPaths.pcde2a00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_34" />
          <path d={svgPaths.p1fb26900} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_35" />
          <path d={svgPaths.p22336600} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_36" />
          <path d={svgPaths.p4f66900} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_37" />
          <path d={svgPaths.p1da33980} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_38" />
          <path d={svgPaths.p2d502180} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_39" />
          <path d={svgPaths.p17f9e980} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_40" />
          <path d={svgPaths.p13c5be80} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_41" />
          <path d={svgPaths.p3a00800} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_42" />
          <path d={svgPaths.p3a0bc500} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_43" />
          <path d={svgPaths.p3c1c0a80} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_44" />
          <path d={svgPaths.p1b975500} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_45" />
          <path d={svgPaths.p29c6a200} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_46" />
          <path d={svgPaths.p188be600} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_47" />
          <path d={svgPaths.p152d4900} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_48" />
          <path d={svgPaths.p1297b980} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_49" />
          <path d={svgPaths.p2e0bab00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_50" />
          <path d={svgPaths.p35bf3600} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_51" />
          <path d={svgPaths.p28b9ed00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_52" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="absolute h-[1350px] left-[-144.51px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[144.508px_-3915px] mask-size-[1440px_5338.391px] top-[3915px] w-[2155.5px]" data-name="Group" style={{ maskImage: `url('${imgGroup}')` }}>
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2155.5 1350">
        <g id="Group" opacity="0.07">
          ...
          <path d={svgPaths.p11eedd80} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_19" />
          <path d={svgPaths.p3e2df780} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_20" />
          <path d={svgPaths.p3836e00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_21" />
          <path d={svgPaths.p18e8190} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_22" />
          <path d={svgPaths.p395b8500} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_23" />
          <path d={svgPaths.p125d6980} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_24" />
          <path d={svgPaths.p31d5baa0} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_25" />
          <path d={svgPaths.pee97980} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_26" />
          <path d={svgPaths.p253bd780} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_27" />
          <path d={svgPaths.p36390e00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_28" />
          <path d={svgPaths.p68c8c80} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_29" />
          <path d={svgPaths.p2e372b00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_30" />
          <path d={svgPaths.p18545c80} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_31" />
          <path d={svgPaths.p1f374280} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_32" />
          <path d={svgPaths.p2dddf9a0} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_33" />
          <path d={svgPaths.p25027c00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_34" />
          <path d={svgPaths.p2a624700} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_35" />
          <path d={svgPaths.p3473d480} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_36" />
          <path d={svgPaths.p78db980} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_37" />
          <path d={svgPaths.p3c602680} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_38" />
          <path d={svgPaths.p801c00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_39" />
          <path d={svgPaths.p2e4001b0} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_40" />
          <path d={svgPaths.p36213400} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_41" />
          <path d={svgPaths.p1af4c7f0} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_42" />
          <path d={svgPaths.p38f75900} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_43" />
          <path d={svgPaths.p36b05800} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_44" />
          <path d={svgPaths.p1d74a000} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_45" />
          <path d={svgPaths.p1c6c7000} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_46" />
          <path d={svgPaths.p150ad100} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_47" />
          <path d={svgPaths.p2fbc6c00} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_48" />
          <path d={svgPaths.p129bfb70} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_49" />
          <path d={svgPaths.p2c9d2900} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_50" />
          <path d={svgPaths.p389a5000} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_51" />
          <path d={svgPaths.p34b6c80} fill="var(--fill-0, #A4C6E6)" fillOpacity="0.2" id="Vector_52" />
  ...
  return (
    <div className="content-stretch flex gap-[13px] items-center relative shrink-0">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[16px] text-center tracking-[1.6px] whitespace-nowrap">
        <p className="leading-[1.02]">100under40 AWARDS</p>
      </div>
    </div>
  );
}
...
function Frame23() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[45px] items-start leading-[0] min-h-px min-w-px relative">
      <div className="flex flex-col font-['Oswald:Bold',sans-serif] font-bold justify-center relative shrink-0 text-[#f0f1f4] text-[72px] w-full">
        <p className="leading-[1.05]">AFRICA’S MOST PRESTIGIOUS RECOGNITION OF YOUNG EXCELLENCE</p>
      </div>
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center not-italic relative shrink-0 text-[#a4c6e6] text-[24px] text-justify tracking-[-1.44px] w-full">
        <p className="leading-[1.4]">Honouring 100 outstanding achievers under 40 drawn from business, governance, arts, technology and social impact. Celebrated at the Gala Night on August 13.</p>
      </div>
    </div>
  );
}
...
function Frame43() {
  return (
    <div className="h-[427px] relative shrink-0 w-[604.759px]">
      <div className="absolute aspect-[1599/1129] left-[-69.24px] right-0 top-[-24.44px]" data-name="IMG-20260324-WA0041 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImg20260324Wa00411.src} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center px-[28px] py-[14px] relative shrink-0">
      ...
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#f0f1f4] text-[19px] text-center tracking-[-1.14px] whitespace-nowrap">
        <p className="leading-[1.02]">Nominate an outstanding under40 achiever</p>
      </div>
...
function Frame40() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[60px] items-start justify-center left-[96px] py-[120px] top-[112px] w-[1248px]">
      <Frame42 />
      <Frame8 />
    </div>
  );
...
function Frame41() {
  return (
    <div className="-translate-x-1/2 absolute bg-[rgba(255,217,102,0.1)] content-stretch flex flex-col gap-[60px] items-center justify-center left-1/2 py-[60px] top-[976px] w-[1248px]">
      <Frame39 />
      <Frame20 />
    </div>
  );
...
export default function Awards() {
  return (
    <ResponsiveArtboard fillViewportWidth>
      <div className="relative min-h-full w-full" data-name="Awards">
