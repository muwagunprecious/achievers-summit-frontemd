...
async function GET(req, { params }) {
    try {
        ...
        let ticket = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].eventTicket.findUnique({
            where: {
                ticketId: id
            }
        });
        ...
        if (!ticket) {
            ...
            const normalizedTicket = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].ticket.findUnique({
                where: {
                    ticketNumber: id
                },
                include: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d5cb2df5._.js.map