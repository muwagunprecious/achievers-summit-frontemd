...
async function POST(req) {
    try {
        ...
        if (!category.isEnabled || category.status !== 'ACTIVE') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "This ticket category is currently closed"
            }, {
                status: 400
            });
        }
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.upsert({
            where: {
                email
            },
            update: {
        ...
        const [newTicket, updatedCategory, eventTicket] = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].$transaction([
            // Create main Ticket record
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].ticket.create({
                data: {
                    id: `TKT-${ticketId}`,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].ticketCategory.update({
                where: {
                    id: category.id
                },
                data: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].eventTicket.create({
                data: {
                    id: `EVT-${ticketId}`,
                    ticketId,
                    fullName,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3831fd88._.js.map